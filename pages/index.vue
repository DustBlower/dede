<template>
  <div class="container">
    ...
    <div class="twoPage">
          ...
          <p class="aboutText">このデザイン学科有志による学祭は初めての試みであり、今まで学祭を経験したことのないメンバーによって構成されています。
　「Enjoy！」をテーマに作る側も見る側も楽しく、を意識した企画となっています！
　また、大学での対面を基礎とした構成になっていますが、オンラインでも楽しんで頂けるように作業過程の動画や完成品の写真を掲載しています！</p>
          </div>
        </div>
      <div class="threePage">
